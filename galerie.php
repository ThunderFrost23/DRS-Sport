...
<html lang="fr">
	...
	<body>
		...
		<br>
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Volkswagen Arteon 2.0 TSI 272 R-LINE EXCLUSIVE 4MOTION DSG7</h4>

				<a href="imageweb/VolkswagenArteonR/volkswagenint.jpeg"> 
					<img src="imageweb/VolkswagenArteonR/volkswagenav.jpeg" alt="imageweb">
				</a>
					...
					<ul>
						...
						<li>Puissance Fiscale: 16 CV</li>
						<li>Moteur: 4 cylindres en lignes, 16 soupapes</li>
						<li>Puissance: 272 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Automatique à 7 rapports</li>
						<li>Roues motrices: 4x4</li>
						<li>Vitesse Maxi: 250 km/h</li>
						<li>0 à 100 km/h: 5,6 sec</li>
						<li><b>Prix: 60 540 €</b></li>
					</ul>

					<img src="imageweb/VolkswagenArteonR/volklogo.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Alfa Romeo 4C SPIDER 1750 TBI 240 ITALIA</h4>

				<a href="imageweb/AlfaRomeo4cSpider/alfaint.jpeg"> 
					<img src="imageweb/AlfaRomeo4cSpider/alfaav.jpg" alt="imageweb">
				</a>

					<ul>
						<li>Nombre de portes/places: 2 portes, 2 places assises</li>
						<li>Motorisation: Essence</li>
						<li>Puissance Fiscale: 14 CV</li>
						<li>Moteur: 4 cylindres en ligne, 16 soupapes</li>
						<li>Puissance: 240 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Automatique à 6 rapports</li>
						<li>Roues motrices: Arrière</li>
						<li>Vitesse Maxi: 258 km/h</li>
						<li>0 à 100 km/h: 4,5 sec</li>
						<li><b>Prix: 69 900 €</b></li>
					</ul>

					<img src="imageweb/AlfaRomeo4cSpider/logoalfa.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Land Rover Range Rover Sport 2 II SDV6 3.0 249 HSE DYNAMIC AUTO</h4>

				<a href="imageweb/LandRoverRangeRoverSport/landint.jpg"> 
					<img src="imageweb/LandRoverRangeRoverSport/landav.jpg" alt="imageweb">
				</a>
					...
					<ul>
						...
						<li>Puissance Fiscale: 16 CV</li>
						<li>Moteur: 6 cylindres en V, 24 soupapes</li>
						<li>Puissance: 249 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Automatique à 8 rapports</li>
						<li>Roues motrices: 4x4</li>
						<li>Vitesse Maxi: 209 km/h</li>
						<li>0 à 100 km/h: 7,9 sec</li>
						<li><b>Prix: 85 500 €</b></li>
					</ul>

					<img src="imageweb/LandRoverRangeRoverSport/logolandrover.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>BMWM M2 Competition</h4>

				<a href="imageweb/BMWM2Competition/bmwint.jpg"> 
					<img src="imageweb/BMWM2Competition/bmwav.jpg" alt="imageweb">
				</a>

					<ul>
						<li>Nombre de portes/places: 3 portes, 4 places assises</li>
						<li>Motorisation: Essence</li>
						<li>Puissance Fiscale: 30 CV</li>
						<li>Moteur: 6 cylindres en ligne</li>
						<li>Puissance: 405 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Manuelle à 6 rapports</li>
						<li>Roues motrices: Arrière</li>
						<li>Vitesse Maxi: 250 km/h</li>
						<li>0 à 100 km/h: 4,4 sec</li>
						<li><b>Prix: 66 950 €</b></li>
					</ul>

					<img src="imageweb/BMWM2Competition/logobmw.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Peugeot RCZ R 1.6 THP 270 Z</h4>

				<a href="imageweb/PeugeotRCZ_R/peugeotint.jpg"> 
					<img src="imageweb/PeugeotRCZ_R/peugeotav.jpg" alt="imageweb">
				</a>
					...
					<ul>
						...
						<li>Puissance Fiscale: 16 CV</li>
						<li>Moteur: 4 cylindres en ligne, 16 soupapes</li>
						<li>Puissance: 270 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Mécanique à 6 rapports</li>
						<li>Roues motrices: Avant</li>
						<li>Vitesse Maxi: 250 km/h</li>
						<li>0 à 100 km/h: 5,9 sec</li>
						<li><b>Prix: 43 350 €</b></li>
					</ul>

					<img src="imageweb/PeugeotRCZ_R/logopeugeot.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Audi RS6 (4E GENERATION) AVANT IV 4.0 TFSI 600 QUATTRO TIPTRONIC 8</h4>

				<a href="imageweb/AudiRS6/audiint.jpg"> 
					<img src="imageweb/AudiRS6/audiav.jpg" alt="imageweb">
				</a>

					<ul>
						<li>Nombre de portes/places: 5 portes, 5 places assises</li>
						<li>Motorisation: Essence</li>
						<li>Puissance Fiscale: 52 CV</li>
						<li>Moteur: 8 cylindres en V, 32 soupapes</li>
						...
						<li>Roues motrices: 4x4</li>
						<li>Vitesse Maxi: 250 km/h</li>
						<li>0 à 100 km/h: 3,6 sec</li>
						<li><b>Prix: 129 150 €</b></li>
					</ul>

					<img src="imageweb/AudiRS6/logoaudi.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Mercedes Classe A 4 AMG IV 45 AMG S 4MATIC+ 8G-DCT</h4>

				<a href="imageweb/MercedesClasseA45AMG/mercedesint.jpeg"> 
					<img src="imageweb/MercedesClasseA45AMG/mercedesav.jpg" alt="imageweb">
				</a>

					<ul>
						<li>Nombre de portes/places: 5 portes, 5 places assises</li>
						<li>Motorisation: Essence</li>
						<li>Puissance Fiscale: 31 CV</li>
						<li>Moteur: 4 cylindres en ligne, 16 soupapes</li>
						<li>Puissance: 421 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Automatique à 8 rapports</li>
						<li>Roues motrices: 4x4</li>
						<li>Vitesse Maxi: 270 km/h</li>
						<li>0 à 100 km/h: 3,9 sec</li>
						<li><b>Prix: 70 100 €</b></li>
					</ul>

					<img src="imageweb/MercedesClasseA45AMG/logomercedes.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Toyota GT86 COUPE 2.0 200</h4>

				<a href="imageweb/ToyotaGT86/toyotaint.jpg"> 
					<img src="imageweb/ToyotaGT86/toyotaav.jpg" alt="imageweb">
				</a>
					...
					<ul>
						...
						<li>Boîte de vitesse, Nombre de rapports: Mécanique à 6 rapports</li>
						<li>Roues motrices: Arrière</li>
						<li>Vitesse Maxi: 226 km/h</li>
						<li>0 à 100 km/h: 7,6 sec</li>
						<li><b>Prix: 36 600 €</b></li>
					</ul>

					<img src="imageweb/ToyotaGT86/logotoyota.png"
					alt="logo">
			...
			<!-- ======================================== -->
			<div class="contenueVoiture">
				<h4>Nissan GT-R R35 Nismo</h4>

				<a href="imageweb/NissanGTRR35Nismo/nissanint.jpg"> 
					<img src="imageweb/NissanGTRR35Nismo/nissanav.jpg" alt="imageweb">
				</a>

					<ul>
						<li>Nombre de portes/places: 2 portes, 4 places assises</li>
						<li>Motorisation: Essence</li>
						<li>Puissance Fiscale: 53 CV</li>
						<li>Moteur: 6 cylindres en V, 24 soupapes</li>
						<li>Puissance: 600 ch</li>
						<li>Type de suralimentation: Turbo</li>
						<li>Boîte de vitesse, Nombre de rapports: Automatique à 6 rapports</li>
						<li>Roues motrices: 4x4</li>
						<li>Vitesse Maxi: 315 km/h</li>
						<li>0 à 100 km/h: 3,2 sec</li>
						<li><b>Prix: 184 950 €</b></li>
					</ul>

					<img src="imageweb/NissanGTRR35Nismo/logonissan.png"
					alt="logo">
